# SkiaLemmings
A lightweight, multi-threaded Lemmings(Catlings), Worms, and Portal hybrid prototype written in pure Delphi, utilizing Skia4Delphi for hardware-accelerated 2D rendering.   
